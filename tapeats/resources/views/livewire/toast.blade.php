<div
    ...
    x-show="visible"
    @hide-toast.window="setTimeout(() => visible = false, 2000)"
    style="background-color: #0C592F;"

    class="fixed top-1 left-1/2 z-50 w-fit min-w-72 -translate-x-1/2 transform rounded-full px-4 py-3 font-poppins shadow-md"
